...
if(isset($_REQUEST['update_id'])) {
	$updatUserId = $_REQUEST['update_id'] ;
	$select = "SELECT name , username , email , country , gender , profile , time FROM userchat WHERE id ='$updatUserId'" ;
...
<form method="post"  action="../backEnd/updateUser.php"  enctype="multipart/form-data" class="registerForm"/>
...
<br>
<img src="../upload/<?php echo  $profile ?>" alt="<?php echo  $name  ?>" height="58px" width="62px" style="border-radius:50%;"/>
<br><br>
<input type="hidden" name="update_id" value="<?php echo $updatUserId ?>" />
